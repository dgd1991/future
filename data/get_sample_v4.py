...
class Sample(object):
	def __init__(self, year, base_path, model_name):
		self.year = year
		self.fea_path = base_path + '/feature/' + str(year) + '_feature_v4.csv'
	...
	def get_sample(self):
		...
		label = label[['code','date','label_7','label_7_weight','label_7_max','label_7_max_weight','label_15','label_15_weight','label_15_max','label_15_max_weight']]
