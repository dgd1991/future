...
class Feature(object):
   ...
   def feature_process(self):
      ...
      raw_k_data.to_csv('E:/pythonProject/future/data/datafile/prediction_sample/{model_name}/test_{date}.csv'.format(model_name=self.model_name, date=str(self.date_end)), mode='a',header=True, index=False, encoding='utf-8')
      return raw_k_data
