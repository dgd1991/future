...
if __name__ == '__main__':
    ...
    while d <= end:
        ...
        downloader = Downloader('E:/pythonProject/stock/data/datafile', date_start=d.strftime("%Y-%m-%d"), date_end=d.strftime("%Y-%m-%d"))
        ...
        downloader.exit()
        d += delta
    # downloader = Downloader('E:/pythonProject/stock/data/datafile', date_start='2022-06-16', date_end='2022-06-16')
    # if len(downloader.stock_df)>0:
    #     downloader.get_k_raw_data()
    #     # downloader.get_quarter_data_all()
    #     # downloader.get_feature_and_label(k_file_name, industry_file_name, quarter_file_name)
