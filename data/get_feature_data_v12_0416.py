...
class Feature(object):
   ...
   def feature_process(self):
      ...
      if self.is_industry1:
         # 一级行业特征
         # raw_k_data = raw_k_data.reset_index(level=0, drop=True)
         # raw_k_data = raw_k_data.reset_index(level=0, drop=False)
         # raw_k_data = raw_k_data[['isST','date','code','open','high','low','close','preclose','amount','turn','tradestatus','pctChg','peTTM','pbMRQ','psTTM','pcfNcfTTM','industry_id_level1','industry_id_level2','industry_id_level3']]
         raw_k_data = pd.read_csv(self.k_file_path)
         raw_k_data_his = pd.read_csv(self.k_file_path_his)
         if is_predict:
            raw_k_data_his = raw_k_data_his[raw_k_data_his['date']>self.tools.get_recent_month_date(self.date_start, -14)]
         ...
         industry_id_level1_k_data = raw_k_data[["industry_id_level1","open_ratio","close_ratio","high_ratio","low_ratio","turn","date","pctChg","peTTM","pcfNcfTTM","pbMRQ", 'industry_id_level1_rise_ratio', 'market_value', 'pctChg_up_limit', 'pctChg_down_limit']].groupby(['industry_id_level1','date']).sum()
         ...
         del raw_k_data
         gc.collect()
         if os.path.isfile('E:/pythonProject/future/data/datafile/industry/' + self.model_name + '/' + 'industry_id_level1_' + str(year-1) + '.csv'):
             industry_id_level1_k_data_his = pd.read_csv('E:/pythonProject/future/data/datafile/industry/' + self.model_name + '/' + 'industry_id_level1_' + str(year-1) + '.csv')
         ...
         if os.path.isfile('E:/pythonProject/future/data/datafile/industry/' + self.model_name + '/' + 'industry_id_level1_' + str(year-1) + '.csv'):
            ...
            industry_id_level1_k_data['industry_id_level1_close'] = industry_id_level1_k_data['industry_id_level1_open_ratio'].apply(lambda x: 100)
         ...
         industry_id_level1_k_data = industry_id_level1_k_data.groupby(level=0).apply(lambda x: self.func(x, 'industry_id_level1_pctChg', 'industry_id_level1_close'))
         industry_id_level1_k_data['industry_id_level1_preclose'] = industry_id_level1_k_data['industry_id_level1_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=2, window=2, center=False).apply(lambda y: y[0]))
         industry_id_level1_k_data['industry_id_level1_open'] = industry_id_level1_k_data['industry_id_level1_preclose']*(industry_id_level1_k_data['industry_id_level1_open_ratio'].apply(lambda x: x + 1))
         industry_id_level1_k_data['industry_id_level1_high'] = industry_id_level1_k_data['industry_id_level1_preclose']*(industry_id_level1_k_data['industry_id_level1_high_ratio'].apply(lambda x: x + 1))
         industry_id_level1_k_data['industry_id_level1_low'] = industry_id_level1_k_data['industry_id_level1_preclose']*(industry_id_level1_k_data['industry_id_level1_low_ratio'].apply(lambda x: x + 1))
         ...
         industry_id_level1_k_data_out = industry_id_level1_k_data_out.reset_index(level=0, drop=False)
         industry_id_level1_k_data_out = industry_id_level1_k_data_out.round(5)
         industry_id_level1_k_data_out.to_csv('E:/pythonProject/future/data/datafile/industry/' + self.model_name + '/' + 'industry_id_level1_' + str(year) + '.csv', mode='w', header=True, index=False)
         del industry_id_level1_k_data_out
         gc.collect()

         industry_id_level1_k_data['industry_id_level1_open_ratio_7d_avg'] = industry_id_level1_k_data['industry_id_level1_open_ratio'].groupby(level=0).apply(lambda x: x.rolling(min_periods=7, window=7, center=False).mean())
         industry_id_level1_k_data['industry_id_level1_close_ratio_7d_avg'] = industry_id_level1_k_data['industry_id_level1_close_ratio'].groupby(level=0).apply(lambda x: x.rolling(min_periods=7, window=7, center=False).mean())
         industry_id_level1_k_data['industry_id_level1_high_ratio_7d_avg'] = industry_id_level1_k_data['industry_id_level1_high_ratio'].groupby(level=0).apply(lambda x: x.rolling(min_periods=7, window=7, center=False).mean())
         industry_id_level1_k_data['industry_id_level1_low_ratio_7d_avg'] = industry_id_level1_k_data['industry_id_level1_low_ratio'].groupby(level=0).apply(lambda x: x.rolling(min_periods=7, window=7, center=False).mean())
         ...
         # industry_id_level1_k_data['industry_id_level1_rsv'] = industry_id_level1_k_data[["industry_id_level1_low", "industry_id_level1_high", "industry_id_level1_close"]].groupby(level=0).apply(lambda x: (x.close-x.low.rolling(min_periods=day_cnt, window=day_cnt, center=False).min())/(x.high.rolling(min_periods=day_cnt, window=day_cnt, center=False).max()-x.low.rolling(min_periods=day_cnt, window=day_cnt, center=False).min()))
            tmp['min'] = tmp["industry_id_level1_low"].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).min())
            tmp['max'] = tmp["industry_id_level1_high"].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).max())
         ...
         for day_cnt in [2, 3, 5, 10, 20, 40]:
            ...
            industry_id_level1_k_data['industry_id_level1_macd_positive_ratio_' + str(day_cnt)] = industry_id_level1_k_data['industry_id_level1_macd_positive'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).mean())
         ...
         # boll线
         for day_cnt in [2, 3, 5, 10, 20, 40]:
            tmp['mb_' + str(day_cnt)] = tmp['industry_id_level1_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).mean())
            tmp['md_' + str(day_cnt)] = tmp['industry_id_level1_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).std())
            tmp['up_' + str(day_cnt)] = tmp['mb_' + str(day_cnt)] + 2 * tmp['md_' + str(day_cnt)]
            tmp['dn_' + str(day_cnt)] = tmp['mb_' + str(day_cnt)] - 2 * tmp['md_' + str(day_cnt)]
            industry_id_level1_k_data['industry_id_level1_width_' + str(day_cnt)] = (4 * tmp['md_' + str(day_cnt)] / tmp['mb_' + str(day_cnt)]).apply(lambda x: max(x, -3) if x<0 else min(x, 3))
            industry_id_level1_k_data['industry_id_level1_close_mb' + str(day_cnt) + '_diff'] = ((tmp['industry_id_level1_close'] - tmp['mb_' + str(day_cnt)])/(2 * tmp['md_' + str(day_cnt)])).apply(lambda x: max(x, -3) if x<0 else min(x, 3))
         ...
         for day_cnt in [26]:
            ...
            tmp['cr_c_' + str(day_cnt) + 'd'] = tmp['cr_' + str(day_cnt) + 'd'].groupby(level=0).apply(lambda x: x.rolling(min_periods=20, window=20, center=False).mean())
            tmp['cr_d_' + str(day_cnt) + 'd'] = tmp['cr_' + str(day_cnt) + 'd'].groupby(level=0).apply(lambda x: x.rolling(min_periods=60, window=60, center=False).mean())
            industry_id_level1_k_data['industry_id_level1_cr_bias_' + str(day_cnt) + 'd'] = (tmp['cr_' + str(day_cnt) + 'd']/tmp['cr_a_' + str(day_cnt) + 'd']).apply(lambda x: max(x, -3) if x<0 else min(x, 3))
         ...
         tmp['rsi_all'] = tmp['price_dif'].apply(lambda x: abs(x))
         for day_cnt in (3, 5, 10, 20, 40):
            tmp['rsi_positive_sum'] = tmp['rsi_positive'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).sum())
            tmp['rsi_all_sum'] = tmp['rsi_all'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).sum())
         ...
         for index in range(len(day_cnt_list)):
            day_cnt = day_cnt_list[index]
            day_cnt_last = day_cnt_list[index-1]
            industry_id_level1_k_data['industry_id_level1_turn_' + str(day_cnt) + 'd' + '_avg'] = tmp['industry_id_level1_turn'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).mean())
            industry_id_level1_k_data['industry_id_level1_turn_rank_' + str(day_cnt) + 'd' + '_avg'] = industry_id_level1_k_data['industry_id_level1_turn_' + str(day_cnt) + 'd' + '_avg']
            ...
            industry_id_level1_k_data['industry_id_level1_turn_' + str(day_cnt) + 'd' + 'max_dif'] = industry_id_level1_k_data['industry_id_level1_turn_' + str(day_cnt) + 'd' + '_avg']/tmp['industry_id_level1_turn'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).max())
            industry_id_level1_k_data['industry_id_level1_turn_' + str(day_cnt) + 'd' + 'min_dif'] = tmp['industry_id_level1_turn'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).min())/industry_id_level1_k_data['industry_id_level1_turn_' + str(day_cnt) + 'd' + '_avg']
            if index>0:
            ...
            tmp['industry_id_level1_close_' + str(day_cnt) + 'd' + '_avg'] = tmp['industry_id_level1_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).mean())
            ...
            industry_id_level1_k_data['industry_id_level1_close_' + str(day_cnt) + 'd' + 'max_dif'] = tmp['industry_id_level1_close']/tmp['industry_id_level1_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).max())
            industry_id_level1_k_data['industry_id_level1_close_' + str(day_cnt) + 'd' + 'min_dif'] = tmp['industry_id_level1_close']/tmp['industry_id_level1_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).min())
         ...
         # 还需要再做一些量价类特征，比如高位放量，低位缩量等等
         for day_cnt in [3, 5, 10, 20, 30, 60, 120, 240]:
            industry_id_level1_k_data['industry_id_level1_max_turn_index' + str(day_cnt) + 'd'] = tmp['industry_id_level1_turn'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).apply(lambda y: y.argmax()))
            industry_id_level1_k_data['industry_id_level1_max_close_index' + str(day_cnt) + 'd'] = tmp['industry_id_level1_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).apply(lambda y: y.argmax()))
            industry_id_level1_k_data['industry_id_level1_min_close_index' + str(day_cnt) + 'd'] = tmp['industry_id_level1_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).apply(lambda y: y.argmin()))
         ...
         del tmp
         gc.collect()
         industry_id_level1_k_data = industry_id_level1_k_data.round(5)
         if os.path.isfile(self.industry1_feature_output_path):
            industry_id_level1_k_data.to_csv(self.industry1_feature_output_path, mode='a', header=False, index=False)
         else:
            industry_id_level1_k_data.to_csv(self.industry1_feature_output_path, mode='w', header=True, index=False)
         del industry_id_level1_k_data
         gc.collect()

      if self.is_industry2:
         # 二级行业特征
         # raw_k_data = raw_k_data.reset_index(level=0, drop=True)
         # raw_k_data = raw_k_data.reset_index(level=0, drop=False)
         # raw_k_data = raw_k_data[['isST','date','code','open','high','low','close','preclose','amount','turn','tradestatus','pctChg','peTTM','pbMRQ','psTTM','pcfNcfTTM','industry_id_level1','industry_id_level2','industry_id_level3']]
         ...
         industry_id_level2_k_data = raw_k_data[["industry_id_level2","open_ratio","close_ratio","high_ratio","low_ratio","turn","date","pctChg","peTTM","pcfNcfTTM","pbMRQ", 'industry_id_level2_rise_ratio', 'market_value','pctChg_up_limit','pctChg_down_limit']].groupby(['industry_id_level2','date']).sum()
         ...
         del raw_k_data
         gc.collect()
         if os.path.isfile('E:/pythonProject/future/data/datafile/industry/' + self.model_name + '/' + 'industry_id_level2_' + str(year-1) + '.csv'):
             industry_id_level2_k_data_his = pd.read_csv('E:/pythonProject/future/data/datafile/industry/' + self.model_name + '/' + 'industry_id_level2_' + str(year-1) + '.csv')
         ...
         if os.path.isfile('E:/pythonProject/future/data/datafile/industry/' + self.model_name + '/' + 'industry_id_level2_' + str(year-1) + '.csv'):
            ...
            industry_id_level2_k_data['industry_id_level2_close'] = industry_id_level2_k_data['industry_id_level2_open_ratio'].apply(lambda x: 100)
         ...
         industry_id_level2_k_data = industry_id_level2_k_data.groupby(level=0).apply(lambda x: self.func(x, 'industry_id_level2_pctChg', 'industry_id_level2_close'))
         industry_id_level2_k_data['industry_id_level2_preclose'] = industry_id_level2_k_data['industry_id_level2_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=2, window=2, center=False).apply(lambda y: y[0]))
         industry_id_level2_k_data['industry_id_level2_open'] = industry_id_level2_k_data['industry_id_level2_preclose']*(industry_id_level2_k_data['industry_id_level2_open_ratio'].apply(lambda x: x + 1))
         industry_id_level2_k_data['industry_id_level2_high'] = industry_id_level2_k_data['industry_id_level2_preclose']*(industry_id_level2_k_data['industry_id_level2_high_ratio'].apply(lambda x: x + 1))
         industry_id_level2_k_data['industry_id_level2_low'] = industry_id_level2_k_data['industry_id_level2_preclose']*(industry_id_level2_k_data['industry_id_level2_low_ratio'].apply(lambda x: x + 1))
        ...
        # 新增板块的最近n天的涨停股票数量，主要评估板块热度
         ...
         industry_id_level2_k_data_out = industry_id_level2_k_data_out.reset_index(level=0, drop=False)
         industry_id_level2_k_data_out = industry_id_level2_k_data_out.round(5)
         industry_id_level2_k_data_out.to_csv('E:/pythonProject/future/data/datafile/industry/' + self.model_name + '/' + 'industry_id_level2_' + str(year) + '.csv', mode='w', header=True, index=False)
         del industry_id_level2_k_data_out
         gc.collect()

         industry_id_level2_k_data['industry_id_level2_open_ratio_7d_avg'] = industry_id_level2_k_data['industry_id_level2_open_ratio'].groupby(level=0).apply(lambda x: x.rolling(min_periods=7, window=7, center=False).mean())
         industry_id_level2_k_data['industry_id_level2_close_ratio_7d_avg'] = industry_id_level2_k_data['industry_id_level2_close_ratio'].groupby(level=0).apply(lambda x: x.rolling(min_periods=7, window=7, center=False).mean())
         industry_id_level2_k_data['industry_id_level2_high_ratio_7d_avg'] = industry_id_level2_k_data['industry_id_level2_high_ratio'].groupby(level=0).apply(lambda x: x.rolling(min_periods=7, window=7, center=False).mean())
         industry_id_level2_k_data['industry_id_level2_low_ratio_7d_avg'] = industry_id_level2_k_data['industry_id_level2_low_ratio'].groupby(level=0).apply(lambda x: x.rolling(min_periods=7, window=7, center=False).mean())
         ...
         # industry_id_level2_k_data['industry_id_level2_rsv'] = industry_id_level2_k_data[["industry_id_level2_low", "industry_id_level2_high", "industry_id_level2_close"]].groupby(level=0).apply(lambda x: (x.close-x.low.rolling(min_periods=day_cnt, window=day_cnt, center=False).min())/(x.high.rolling(min_periods=day_cnt, window=day_cnt, center=False).max()-x.low.rolling(min_periods=day_cnt, window=day_cnt, center=False).min()))
            tmp['min'] = tmp["industry_id_level2_low"].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).min())
            tmp['max'] = tmp["industry_id_level2_high"].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).max())
         ...
         for day_cnt in [2, 3, 5, 10, 20, 40]:
            ...
            industry_id_level2_k_data['industry_id_level2_macd_positive_ratio_' + str(day_cnt)] = industry_id_level2_k_data['industry_id_level2_macd_positive'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).mean())
         ...
         # boll线
         for day_cnt in [2, 3, 5, 10, 20, 40]:
            tmp['mb_' + str(day_cnt)] = tmp['industry_id_level2_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).mean())
            tmp['md_' + str(day_cnt)] = tmp['industry_id_level2_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).std())
            tmp['up_' + str(day_cnt)] = tmp['mb_' + str(day_cnt)] + 2 * tmp['md_' + str(day_cnt)]
            tmp['dn_' + str(day_cnt)] = tmp['mb_' + str(day_cnt)] - 2 * tmp['md_' + str(day_cnt)]
            industry_id_level2_k_data['industry_id_level2_width_' + str(day_cnt)] = (4 * tmp['md_' + str(day_cnt)] / tmp['mb_' + str(day_cnt)]).apply(lambda x: max(x, -3) if x<0 else min(x, 3))
            industry_id_level2_k_data['industry_id_level2_close_mb' + str(day_cnt) + '_diff'] = ((tmp['industry_id_level2_close'] - tmp['mb_' + str(day_cnt)])/(2 * tmp['md_' + str(day_cnt)])).apply(lambda x: max(x, -3) if x<0 else min(x, 3))
         ...
         for day_cnt in [26]:
            ...
            tmp['cr_c_' + str(day_cnt) + 'd'] = tmp['cr_' + str(day_cnt) + 'd'].groupby(level=0).apply(lambda x: x.rolling(min_periods=20, window=20, center=False).mean())
            tmp['cr_d_' + str(day_cnt) + 'd'] = tmp['cr_' + str(day_cnt) + 'd'].groupby(level=0).apply(lambda x: x.rolling(min_periods=60, window=60, center=False).mean())
            industry_id_level2_k_data['industry_id_level2_cr_bias_' + str(day_cnt) + 'd'] = (tmp['cr_' + str(day_cnt) + 'd']/tmp['cr_a_' + str(day_cnt) + 'd']).apply(lambda x: max(x, -3) if x<0 else min(x, 3))
         ...
         for index in range(len(day_cnt_list)):
            day_cnt = day_cnt_list[index]
            day_cnt_last = day_cnt_list[index-1]
            industry_id_level2_k_data['industry_id_level2_turn_' + str(day_cnt) + 'd' + '_avg'] = tmp['industry_id_level2_turn'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).mean())
            industry_id_level2_k_data['industry_id_level2_turn_rank_' + str(day_cnt) + 'd' + '_avg'] = industry_id_level2_k_data['industry_id_level2_turn_' + str(day_cnt) + 'd' + '_avg']
            ...
            industry_id_level2_k_data['industry_id_level2_turn_' + str(day_cnt) + 'd' + 'max_dif'] = industry_id_level2_k_data['industry_id_level2_turn_' + str(day_cnt) + 'd' + '_avg']/tmp['industry_id_level2_turn'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).max())
            industry_id_level2_k_data['industry_id_level2_turn_' + str(day_cnt) + 'd' + 'min_dif'] = tmp['industry_id_level2_turn'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).min())/industry_id_level2_k_data['industry_id_level2_turn_' + str(day_cnt) + 'd' + '_avg']
            if index>0:
            ...
            tmp['industry_id_level2_close_' + str(day_cnt) + 'd' + '_avg'] = tmp['industry_id_level2_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).mean())
            ...
            industry_id_level2_k_data['industry_id_level2_close_' + str(day_cnt) + 'd' + 'max_dif'] = tmp['industry_id_level2_close']/tmp['industry_id_level2_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).max())
            industry_id_level2_k_data['industry_id_level2_close_' + str(day_cnt) + 'd' + 'min_dif'] = tmp['industry_id_level2_close']/tmp['industry_id_level2_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).min())
         ...
         # 还需要再做一些量价类特征，比如高位放量，低位缩量等等
         for day_cnt in [3, 5, 10, 20, 30, 60, 120, 240]:
            industry_id_level2_k_data['industry_id_level2_max_turn_index' + str(day_cnt) + 'd'] = tmp['industry_id_level2_turn'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).apply(lambda y: y.argmax()))
            industry_id_level2_k_data['industry_id_level2_max_close_index' + str(day_cnt) + 'd'] = tmp['industry_id_level2_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).apply(lambda y: y.argmax()))
            industry_id_level2_k_data['industry_id_level2_min_close_index' + str(day_cnt) + 'd'] = tmp['industry_id_level2_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).apply(lambda y: y.argmin()))
         ...
         del tmp
         gc.collect()
         industry_id_level2_k_data = industry_id_level2_k_data.round(5)
         if os.path.isfile(self.industry2_feature_output_path):
            industry_id_level2_k_data.to_csv(self.industry2_feature_output_path, mode='a', header=False, index=False)
         else:
            industry_id_level2_k_data.to_csv(self.industry2_feature_output_path, mode='w', header=True, index=False)
         del industry_id_level2_k_data
         gc.collect()

      if self.is_industry3:
      # 三级行业特征
         # raw_k_data = raw_k_data.reset_index(level=0, drop=True)
         # raw_k_data = raw_k_data.reset_index(level=0, drop=False)
         # raw_k_data = raw_k_data[['isST','date','code','open','high','low','close','preclose','amount','turn','tradestatus','pctChg','peTTM','pbMRQ','psTTM','pcfNcfTTM','industry_id_level1','industry_id_level2','industry_id_level3']]
         ...
         industry_id_level3_k_data = raw_k_data[["industry_id_level3","open_ratio","close_ratio","high_ratio","low_ratio","turn","date","pctChg","peTTM","pcfNcfTTM","pbMRQ", 'industry_id_level3_rise_ratio', 'market_value','pctChg_up_limit','pctChg_down_limit']].groupby(['industry_id_level3','date']).sum()
         ...
         del raw_k_data
         gc.collect()
         if os.path.isfile('E:/pythonProject/future/data/datafile/industry/' + self.model_name + '/' + 'industry_id_level3_' + str(year-1) + '.csv'):
             industry_id_level3_k_data_his = pd.read_csv('E:/pythonProject/future/data/datafile/industry/' + self.model_name + '/' + 'industry_id_level3_' + str(year-1) + '.csv')
         ...
         if os.path.isfile('E:/pythonProject/future/data/datafile/industry/' + self.model_name + '/' + 'industry_id_level3_' + str(year-1) + '.csv'):
            ...
            industry_id_level3_k_data['industry_id_level3_close'] = industry_id_level3_k_data['industry_id_level3_open_ratio'].apply(lambda x: 100)
         ...
         industry_id_level3_k_data = industry_id_level3_k_data.groupby(level=0).apply(lambda x: self.func(x, 'industry_id_level3_pctChg', 'industry_id_level3_close'))
         industry_id_level3_k_data['industry_id_level3_preclose'] = industry_id_level3_k_data['industry_id_level3_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=2, window=2, center=False).apply(lambda y: y[0]))
         industry_id_level3_k_data['industry_id_level3_open'] = industry_id_level3_k_data['industry_id_level3_preclose']*(industry_id_level3_k_data['industry_id_level3_open_ratio'].apply(lambda x: x + 1))
         industry_id_level3_k_data['industry_id_level3_high'] = industry_id_level3_k_data['industry_id_level3_preclose']*(industry_id_level3_k_data['industry_id_level3_high_ratio'].apply(lambda x: x + 1))
         industry_id_level3_k_data['industry_id_level3_low'] = industry_id_level3_k_data['industry_id_level3_preclose']*(industry_id_level3_k_data['industry_id_level3_low_ratio'].apply(lambda x: x + 1))
        ...
        # 新增板块的最近n天的涨停股票数量，主要评估板块热度
         ...
         industry_id_level3_k_data_out = industry_id_level3_k_data_out.reset_index(level=0, drop=False)
         industry_id_level3_k_data_out = industry_id_level3_k_data_out.round(5)
         industry_id_level3_k_data_out.to_csv('E:/pythonProject/future/data/datafile/industry/' + self.model_name + '/' + 'industry_id_level3_' + str(year) + '.csv', mode='w', header=True, index=False)
         del industry_id_level3_k_data_out
         gc.collect()

         industry_id_level3_k_data['industry_id_level3_open_ratio_7d_avg'] = industry_id_level3_k_data['industry_id_level3_open_ratio'].groupby(level=0).apply(lambda x: x.rolling(min_periods=7, window=7, center=False).mean())
         industry_id_level3_k_data['industry_id_level3_close_ratio_7d_avg'] = industry_id_level3_k_data['industry_id_level3_close_ratio'].groupby(level=0).apply(lambda x: x.rolling(min_periods=7, window=7, center=False).mean())
         industry_id_level3_k_data['industry_id_level3_high_ratio_7d_avg'] = industry_id_level3_k_data['industry_id_level3_high_ratio'].groupby(level=0).apply(lambda x: x.rolling(min_periods=7, window=7, center=False).mean())
         industry_id_level3_k_data['industry_id_level3_low_ratio_7d_avg'] = industry_id_level3_k_data['industry_id_level3_low_ratio'].groupby(level=0).apply(lambda x: x.rolling(min_periods=7, window=7, center=False).mean())
         ...
         # industry_id_level3_k_data['industry_id_level3_rsv'] = industry_id_level3_k_data[["industry_id_level3_low", "industry_id_level3_high", "industry_id_level3_close"]].groupby(level=0).apply(lambda x: (x.close-x.low.rolling(min_periods=day_cnt, window=day_cnt, center=False).min())/(x.high.rolling(min_periods=day_cnt, window=day_cnt, center=False).max()-x.low.rolling(min_periods=day_cnt, window=day_cnt, center=False).min()))
            tmp['min'] = tmp["industry_id_level3_low"].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).min())
            tmp['max'] = tmp["industry_id_level3_high"].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).max())
         ...
         for day_cnt in [2, 3, 5, 10, 20, 40]:
            ...
            industry_id_level3_k_data['industry_id_level3_macd_positive_ratio_' + str(day_cnt)] = industry_id_level3_k_data['industry_id_level3_macd_positive'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).mean())
         ...
         # boll线
         for day_cnt in [2, 3, 5, 10, 20, 40]:
            tmp['mb_' + str(day_cnt)] = tmp['industry_id_level3_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).mean())
            tmp['md_' + str(day_cnt)] = tmp['industry_id_level3_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).std())
            tmp['up_' + str(day_cnt)] = tmp['mb_' + str(day_cnt)] + 2 * tmp['md_' + str(day_cnt)]
            tmp['dn_' + str(day_cnt)] = tmp['mb_' + str(day_cnt)] - 2 * tmp['md_' + str(day_cnt)]
            industry_id_level3_k_data['industry_id_level3_width_' + str(day_cnt)] = (4 * tmp['md_' + str(day_cnt)] / tmp['mb_' + str(day_cnt)]).apply(lambda x: max(x, -3) if x<0 else min(x, 3))
            industry_id_level3_k_data['industry_id_level3_close_mb' + str(day_cnt) + '_diff'] = ((tmp['industry_id_level3_close'] - tmp['mb_' + str(day_cnt)])/(2 * tmp['md_' + str(day_cnt)])).apply(lambda x: max(x, -3) if x<0 else min(x, 3))
         ...
         for day_cnt in [26]:
            ...
            tmp['cr_c_' + str(day_cnt) + 'd'] = tmp['cr_' + str(day_cnt) + 'd'].groupby(level=0).apply(lambda x: x.rolling(min_periods=20, window=20, center=False).mean())
            tmp['cr_d_' + str(day_cnt) + 'd'] = tmp['cr_' + str(day_cnt) + 'd'].groupby(level=0).apply(lambda x: x.rolling(min_periods=60, window=60, center=False).mean())
            industry_id_level3_k_data['industry_id_level3_cr_bias_' + str(day_cnt) + 'd'] = (tmp['cr_' + str(day_cnt) + 'd']/tmp['cr_a_' + str(day_cnt) + 'd']).apply(lambda x: max(x, -3) if x<0 else min(x, 3))
         ...
         for index in range(len(day_cnt_list)):
            day_cnt = day_cnt_list[index]
            day_cnt_last = day_cnt_list[index-1]
            industry_id_level3_k_data['industry_id_level3_turn_' + str(day_cnt) + 'd' + '_avg'] = tmp['industry_id_level3_turn'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).mean())
            industry_id_level3_k_data['industry_id_level3_turn_rank_' + str(day_cnt) + 'd' + '_avg'] = industry_id_level3_k_data['industry_id_level3_turn_' + str(day_cnt) + 'd' + '_avg']
            ...
            industry_id_level3_k_data['industry_id_level3_turn_' + str(day_cnt) + 'd' + 'max_dif'] = industry_id_level3_k_data['industry_id_level3_turn_' + str(day_cnt) + 'd' + '_avg']/tmp['industry_id_level3_turn'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).max())
            industry_id_level3_k_data['industry_id_level3_turn_' + str(day_cnt) + 'd' + 'min_dif'] = tmp['industry_id_level3_turn'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).min())/industry_id_level3_k_data['industry_id_level3_turn_' + str(day_cnt) + 'd' + '_avg']
            if index>0:
            ...
            tmp['industry_id_level3_close_' + str(day_cnt) + 'd' + '_avg'] = tmp['industry_id_level3_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).mean())
            ...
            industry_id_level3_k_data['industry_id_level3_close_' + str(day_cnt) + 'd' + 'max_dif'] = tmp['industry_id_level3_close']/tmp['industry_id_level3_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).max())
            industry_id_level3_k_data['industry_id_level3_close_' + str(day_cnt) + 'd' + 'min_dif'] = tmp['industry_id_level3_close']/tmp['industry_id_level3_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).min())
         ...
         # 还需要再做一些量价类特征，比如高位放量，低位缩量等等
         for day_cnt in [3, 5, 10, 20, 30, 60, 120, 240]:
            industry_id_level3_k_data['industry_id_level3_max_turn_index' + str(day_cnt) + 'd'] = tmp['industry_id_level3_turn'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).apply(lambda y: y.argmax()))
            industry_id_level3_k_data['industry_id_level3_max_close_index' + str(day_cnt) + 'd'] = tmp['industry_id_level3_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).apply(lambda y: y.argmax()))
            industry_id_level3_k_data['industry_id_level3_min_close_index' + str(day_cnt) + 'd'] = tmp['industry_id_level3_close'].groupby(level=0).apply(lambda x: x.rolling(min_periods=day_cnt, window=day_cnt, center=False).apply(lambda y: y.argmin()))
         ...
         del tmp
         gc.collect()
         industry_id_level3_k_data = industry_id_level3_k_data.round(5)
         if os.path.isfile(self.industry3_feature_output_path):
            industry_id_level3_k_data.to_csv(self.industry3_feature_output_path, mode='a', header=False, index=False)
         else:
            industry_id_level3_k_data.to_csv(self.industry3_feature_output_path, mode='w', header=True, index=False)
         del industry_id_level3_k_data
         gc.collect()
      ...
      if self.is_market:
         ...
         for index in range(len(day_cnt_list)):
            day_cnt = day_cnt_list[index]
            all_data_raw['all_pctChg_' + str(day_cnt)] = all_data_raw['all_pctChg'].rolling(min_periods=day_cnt, window=day_cnt, center=False).mean()
            all_data_raw['all_turn_' + str(day_cnt)] = all_data_raw['all_turn'].rolling(min_periods=day_cnt, window=day_cnt, center=False).mean()
            all_data_raw['all_rise_ratio_' + str(day_cnt)] = all_data_raw['all_rise_ratio'].rolling(min_periods=day_cnt, window=day_cnt, center=False).mean()
         ...
         zs_data = pd.read_csv(self.code_feature_output_path)
         zs_data = zs_data[zs_data['code'] == 'sh.000001']
         ...
         all_data_raw = all_data_raw.round(5)
         if os.path.isfile(self.market_feature_output_path):
            all_data_raw.to_csv(self.market_feature_output_path, mode='a', header=False, index=False)
         else:
            all_data_raw.to_csv(self.market_feature_output_path, mode='w', header=True, index=False)
         del all_data_raw
         gc.collect()
      # if self.is_predict:
      #    sample = feature_all
