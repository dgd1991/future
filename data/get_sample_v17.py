...
class Sample(object):
	...
	def get_sample(self):
		...
		feature.to_csv('{output_dir}/sample/{model_name}/train_sample_{year}.csv'.format(output_dir=self.output_dir, model_name='model_v17', year=str(self.year)), mode='w',header=True, index=False, encoding='utf-8')
		del feature
		gc.collect()
