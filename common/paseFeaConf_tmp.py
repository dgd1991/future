...
def parse_feaconf(commonPath, modelName):
    ...
    with open(conf_file, "r") as fin:
        ...
        while line:
            ...
            if is_used.strip() == '1' and not shared_field_name.__contains__(shared_field.strip()):
                shared_field_name.append(shared_field.strip())
            line = fin.readline()
    print(shared_field_name)
if __name__ == '__main__':
    confPath = "E:/pythonProject/future/common/"
    modelName = "model_v17_all"
