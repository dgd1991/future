...
for year in years:
	...
	for fea in bucket_fea_name:
		...
		if os.path.isfile('E:/pythonProject/future/data/datafile/sample/model_v15_eval/' + fea +'.csv'):
			his_data = pd.read_csv('E:/pythonProject/future/data/datafile/sample/model_v15_eval/' + fea + '.csv')
			...
			bucket_fea.to_csv('E:/pythonProject/future/data/datafile/sample/model_v15_eval/' + fea + '.csv', mode='w', header=True, index=False)
		else:
			bucket_fea.to_csv('E:/pythonProject/future/data/datafile/sample/model_v15_eval/' + fea + '.csv', mode='w', header=True, index=False)
