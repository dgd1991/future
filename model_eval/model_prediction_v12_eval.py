...
class ModelEval(object):
	...
	def eval(self):
		...
		df.columns = ['date', 'code', 'industry_name_level1', 'industry_name_level2', 'industry_name_level3', 'predition', 'label_7', 'pctChg_7', 'sh_pctChg_7', 'label_15', 'pctChg_15', 'sh_pctChg_15']
		...
		# # label_7
		df_head30 = df.sort_values(['date', 'predition'], ascending=[True, False]).groupby('date').head(150)
